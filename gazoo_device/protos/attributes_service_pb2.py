...
_CLUSTERTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='ZCL_ACTIONS_CLUSTER_ID', index=16, number=37,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
...
_ATTRIBUTEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tlv_data', full_name='chip.rpc.AttributeData.tlv_data', index=8,
  ...
  oneofs=[
    ...
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_tlv_data', full_name='chip.rpc.AttributeData._tlv_data',
...
_ATTRIBUTEDATA.oneofs_by_name['_tlv_data'].fields.append(
  _ATTRIBUTEDATA.fields_by_name['tlv_data'])
_ATTRIBUTEDATA.fields_by_name['tlv_data'].containing_oneof = _ATTRIBUTEDATA.oneofs_by_name['_tlv_data']
