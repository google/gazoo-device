...
"""Test suite for Matter devices with Temperature Sensor endpoint."""
from typing import Type
from gazoo_device.tests.functional_tests.mixins import pressure_measurement_cluster_suite
...
class PressureSensorTestSuite(
  ...
  def setup_class(self) -> None:
    ...
    super().setup_class()
    self.endpoint = self.device.pressure_sensor
  ...
  def is_applicable_to(cls, device_type: str,
    ...
    return gdm_test_base.whether_implements_matter_endpoint(
        device_class, device_name, "pressure_sensor")
