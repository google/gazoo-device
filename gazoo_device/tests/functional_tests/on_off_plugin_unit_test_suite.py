...
"""Test suite for Matter devices with On/Off Plug-in Unit endpoint."""
...
class OnOffPluginUnitTestSuite(
  ...
  """Tests for the On/Off Plug-in Unit endpoint."""

  def setup_class(self) -> None:
    """Sets the endpoint instance."""
    super().setup_class()
    self.endpoint = self.device.on_off_plugin_unit
  ...
  def is_applicable_to(cls,
    ...
    return gdm_test_base.whether_implements_matter_endpoint(
        device_class, device_name, "on_off_plugin_unit")
