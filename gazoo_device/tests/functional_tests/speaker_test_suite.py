...
"""Test suite for Matter devices with speaker endpoint."""
...
class SpeakerTestSuite(
  ...
  """Tests for the speaker endpoint."""

  def setup_class(self) -> None:
    """Sets the endpoint instance."""
    super().setup_class()
    self.endpoint = self.device.speaker
  ...
  def is_applicable_to(cls, device_type: str,
    ...
    return gdm_test_base.whether_implements_matter_endpoint(
        device_class, device_name, "speaker")
