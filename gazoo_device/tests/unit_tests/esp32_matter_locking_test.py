...
"""Unit tests for device class Esp32MatterLocking."""
...
class Esp32MatterLockingTests(fake_device_test_case.FakeDeviceTestCase):
  """Unit tests for device class Esp32MatterLocking."""
  ...
  def setUp(self):
    ...
    self.uut = esp32_matter_locking.Esp32MatterLocking(
        self.mock_manager,
        self.device_config,
