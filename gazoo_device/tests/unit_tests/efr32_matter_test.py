...
class Efr32MatterTests(fake_device_test_case.FakeDeviceTestCase):
  ...
  def test_platform_attribute(self):
    ...
    self.assertEqual("EFR32MG", self.uut.platform)
