...
"""Device logs for matter controller devices."""

import textwrap

from gazoo_device.tests.unit_tests.utils import debian_device_logs
...
DESCRIPTOR_DEVICE_TYPE_LIST_COMMAND = (
    "/usr/local/bin/chip-tool descriptor read device-type-list 1234 1 "
    "--trace_decode 1"
)
DESCRIPTOR_DEVICE_TYPE_LIST_RESPONSE = textwrap.dedent("""
...
_COMMON_RESPONSES = (
    ...
    {
        "cmd": (
            "/usr/local/bin/chip-tool pairing ble-wifi 1234"
            " hex:776966692d73736964 hex:776966692d70617373776f7264 20202021"
            " 3840 --trace_decode 1"
        ),
    ...
    {
        "cmd": (
            "/usr/local/bin/chip-tool pairing onnetwork 1234 20202021"
            " --trace_decode 1"
        ),
        "resp": _COMMISSION_SUCCESS_RESPONSE,
        "code": 0,
    ...
    {
        "cmd": (
            "/usr/local/bin/chip-tool pairing onnetwork-long 1234 20202021 3840"
            " --trace_decode 1"
        ),
        "resp": _COMMISSION_SUCCESS_RESPONSE,
        "code": 0,
    ...
    {
        "cmd": (
            "/usr/local/bin/chip-tool pairing ble-thread 1234 hex:abcd "
            "20202021 3840 --trace_decode 1"
        ),
        "resp": _COMMISSION_SUCCESS_RESPONSE,
        "code": 0,
    },
    {
        "cmd": (
            "/usr/local/bin/chip-tool pairing code 1234 MT:Y.K9042C00KA0648G00"
            " --trace_decode 1"
        ),
        "resp": _COMMISSION_SUCCESS_RESPONSE,
        "code": 0,
    ...
    {
        "cmd": (
            "/usr/local/bin/chip-tool pairing onnetwork 1234 00000000"
            " --trace_decode 1"
        ),
    ...
    {
        "cmd": "/usr/local/bin/chip-tool pairing unpair 1234 --trace_decode 1",
    ...
    {
        "cmd": "/usr/local/bin/chip-tool pairing unpair 0000 --trace_decode 1",
        "resp": _COMMAND_TIMEOUT_FAILURE,
        "code": 1,
    },
    {
    ...
    {
        "cmd": (
            "/usr/local/bin/chip-tool onoff read on-off 1234 1 --trace_decode 1"
        ),
        "resp": textwrap.dedent("""
    ...
    {
        "cmd": (
            "/usr/local/bin/chip-tool onoff toggle  1234 1  --trace_decode 1"
        ),
        "resp": textwrap.dedent("""
    ...
    },
    {
        "cmd": (
            ...
            "--timedInteractionTimeoutMs 1000 --trace_decode 1"
        ),
        "resp": textwrap.dedent("""
    ...
    {
        "cmd": (
            "/usr/local/bin/chip-tool descriptor read device-type-list 1234 0"
            " --trace_decode 1"
        ),
        "resp": DESCRIPTOR_DEVICE_TYPE_LIST_RESPONSE.format(DEVICE_TYPE_ID=22),
        "code": 0,
    },
    {
        "cmd": DESCRIPTOR_DEVICE_TYPE_LIST_COMMAND,
        "resp": DESCRIPTOR_DEVICE_TYPE_LIST_RESPONSE.format(DEVICE_TYPE_ID=256),
        "code": 0,
    },
    {
    ...
    },
    {
        ...
        "resp": (
            "[1658180504.043668][493408:493408] CHIP:TOO: Clearing Default"
            " storage"
        ),
        "code": 0,
    },
    ...
    },
    {
        ...
        "resp": (
            "[1671146232.162251][120573:120579] CHIP:DMG: 				Data = 1,\n"
    ...
    {
        "cmd": (
            "mv /tmp/chip_certs_folder_temp/some_temp_dir/* path/to/device-dest"
        ),
        "resp": "",
        "code": 0,
    },
...
_LINUX_RESPONSES = (
    {
        ...
        "resp": textwrap.dedent("""
            ...
            [1653012051.834362][1030538:1030543] CHIP:DMG: 				Data = 1,
    ...
    },
    {
        ...
        "resp": textwrap.dedent("""
            ...
            [1653012222.679278][1030572:1030577] CHIP:DMG: 			    Data = 3
            ...
            [1653012222.679161][1030572:1030577] CHIP:DMG: 					Attribute = 0x0000_0001,
            [1653012222.679200][1030572:1030577] CHIP:DMG: 				}
            [1653012222.679278][1030572:1030577] CHIP:DMG: 			    Data = 6
            [1653012222.679394][1030572:1030577] CHIP:DMG: 			},
            [1653012222.679428][1030572:1030577] CHIP:DMG:
            [1653012222.679463][1030572:1030577] CHIP:DMG: 		},
    ...
    },
    {
        ...
        "resp": textwrap.dedent("""
            ...
            [1653012222.679969][1030572:1030577] CHIP:DMG: 				}
            [1653012222.680011][1030572:1030577] CHIP:DMG:
            [1653012222.680056][1030572:1030577] CHIP:DMG: 					Data = 41,
            [1653012222.680088][1030572:1030577] CHIP:DMG: 			},
            [1653012222.680128][1030572:1030577] CHIP:DMG:
            [1653012222.680153][1030572:1030577] CHIP:DMG: 		},
            [1653012222.679535][1030572:1030577] CHIP:DMG: 		AttributeReportIB =
            ...
            [1653012222.679969][1030572:1030577] CHIP:DMG: 				}
            [1653012222.680011][1030572:1030577] CHIP:DMG:
            [1653012222.680056][1030572:1030577] CHIP:DMG: 					Data = 42,
            [1653012222.680088][1030572:1030577] CHIP:DMG: 			},
            [1653012222.680128][1030572:1030577] CHIP:DMG:
            [1653012222.680153][1030572:1030577] CHIP:DMG: 		},
            [1653012222.679535][1030572:1030577] CHIP:DMG: 		AttributeReportIB =
            ...
            [1653012222.679969][1030572:1030577] CHIP:DMG: 				}
            [1653012222.680011][1030572:1030577] CHIP:DMG:
            [1653012222.680056][1030572:1030577] CHIP:DMG: 					Data = 43,
            [1653012222.680088][1030572:1030577] CHIP:DMG: 			},
            [1653012222.680128][1030572:1030577] CHIP:DMG:
            [1653012222.680153][1030572:1030577] CHIP:DMG: 		},
            [1653012222.679535][1030572:1030577] CHIP:DMG: 		AttributeReportIB =
            ...
            [1653012222.679969][1030572:1030577] CHIP:DMG: 				}
            [1653012222.680011][1030572:1030577] CHIP:DMG:
            [1653012222.680056][1030572:1030577] CHIP:DMG: 					Data = 44,
            [1653012222.680088][1030572:1030577] CHIP:DMG: 			},
            [1653012222.680128][1030572:1030577] CHIP:DMG:
            [1653012222.680153][1030572:1030577] CHIP:DMG: 		},
            [1653012222.679535][1030572:1030577] CHIP:DMG: 		AttributeReportIB =
            ...
            [1653012222.679969][1030572:1030577] CHIP:DMG: 				}
            [1653012222.680011][1030572:1030577] CHIP:DMG:
            [1653012222.680056][1030572:1030577] CHIP:DMG: 					Data = 45,
            [1653012222.680088][1030572:1030577] CHIP:DMG: 			},
            [1653012222.680128][1030572:1030577] CHIP:DMG:
            [1653012222.680153][1030572:1030577] CHIP:DMG: 		},
    ...
    },
    {
        ...
        "resp": textwrap.dedent("""
            [1690498327.174820][1123297:1123297] CHIP:TOO: Missing cluster name
            Usage:
            /usr/local/bin/chip-tool cluster_name command_name [param1 param2 ...]
            ...
            | * storage                                                                           |
            +-------------------------------------------------------------------------------------+
            [1690498327.175165][1123297:1123297] CHIP:TOO: Run command failure: ../examples/chip-tool/commands/common/Commands.cpp:196: Error 0x0000002F
          """),
        "code": 0,
    },
)
...
_RPI_RESPONSES = (
    {
        ...
        "resp": textwrap.dedent("""
            ...
            [1653012051.834396][1030538:1030543] CHIP:DMG: 						1 (unsigned),
    ...
    },
    {
        ...
        "resp": textwrap.dedent("""
            ...
            [1653012222.679309][1030572:1030577] CHIP:DMG: 						3 (unsigned), 6 (unsigned),
    ...
    },
    {
        ...
        "resp": textwrap.dedent("""
            ...
            [1653012222.679236][1030572:1030577] CHIP:DMG:
            [1653012222.679278][1030572:1030577] CHIP:DMG: 					Data = [
            [1653012222.679309][1030572:1030577] CHIP:DMG:                                          40 (unsigned), 41 (unsigned), 42 (unsigned), 43 (unsigned), 44 (unsigned)
            [1653012222.679352][1030572:1030577] CHIP:DMG: 					],
            [1653012222.679394][1030572:1030577] CHIP:DMG: 			},
            [1653012222.679428][1030572:1030577] CHIP:DMG:
            [1653012222.679463][1030572:1030577] CHIP:DMG: 		},
            ...
            [1653012222.679969][1030572:1030577] CHIP:DMG: 				}
            [1653012222.680011][1030572:1030577] CHIP:DMG:
            [1653012222.680056][1030572:1030577] CHIP:DMG: 					Data = 45 (unsigned),
            [1653012222.680088][1030572:1030577] CHIP:DMG: 			},
            [1653012222.680128][1030572:1030577] CHIP:DMG:
            [1653012222.680153][1030572:1030577] CHIP:DMG: 		},
            [1653012222.682267][1030572:1030577] CHIP:DMG:
...
RPI_BEHAVIOR = immutabledict.immutabledict({
    **raspbian_device_logs.DEFAULT_BEHAVIOR,
    **ssh_device_logs.make_device_responses(_COMMON_RESPONSES),
    **ssh_device_logs.make_device_responses(_RPI_RESPONSES),
})

LINUX_BEHAVIOR = immutabledict.immutabledict({
    **debian_device_logs.DEFAULT_BEHAVIOR,
    **ssh_device_logs.make_device_responses(_COMMON_RESPONSES),
    **ssh_device_logs.make_device_responses(_LINUX_RESPONSES),
})
