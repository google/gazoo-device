...
"""Unit tests for the MatterControllerChipTool on raspberry pi capability."""
...
class MatterEndpointsAccessorChipToolOnRaspberryPiTests(
    fake_device_test_case.FakeDeviceTestCase,
    matter_endpoint_accessor_test.MatterEndpointAccessorTestMixin,
):
  """Unit tests for the MatterControllerChipTool on raspberry pi capability implementation."""
