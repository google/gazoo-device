...
"""Unit test mixin for testing primary and auxiliary device base class functionality."""
...
class DeviceBaseClassTestMixin(parameterized.TestCase):
  """Unit test mixin for testing primary and auxiliary device base class functionality."""
  ...
  def test_execute_health_check_methods_device_error(self):
    ...
    with mock.patch.object(self.uut.logger, "info") as mock_info:
      health_checks = [self.uut.check_3]
