...
"""Matter Extended color light endpoint.

This endpoint module corresponds to the
"Extended color light" Matter device type which defines required clusters
in the Matter spec 1.0.

A Extended color light endpoint houses an instance of Extended color light
...
class ExtendedColorLightEndpoint(
