...
"""Interface for the Matter Air Quality cluster capability."""
...
class AirQualityClusterBase(cluster_base.ClusterBase, metaclass=abc.ABCMeta):
  """Matter Air Quality Control cluster capability."""
