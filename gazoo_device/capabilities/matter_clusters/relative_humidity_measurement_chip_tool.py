...
"""chip-tool implementation of Matter Relative Humidity Measurement cluster capability.
"""
from gazoo_device.capabilities import matter_enums
from gazoo_device.capabilities.matter_clusters.interfaces import measurement_base


class RelativeHumidityMeasurementClusterChipTool(
    measurement_base.MeasurementClusterChipToolBase):
  """Matter Relative Humidity Measurement cluster capability."""
