...
"""Matter device base class for ESP32 Espressif platform."""
import os
...
class Esp32MatterDevice(gazoo_device_base.GazooDeviceBase):
  """Matter device base class for ESP32 platform.

  ESP32 Matter devices run on FreeRTOS with Matter functionality.
  """
  ...
  def shell(self,
    ...
    Raises:
      NotImplementedError:
      shell method is not implemented for ESP32 Matter device.
    """
