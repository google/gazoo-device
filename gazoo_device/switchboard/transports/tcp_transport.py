...
TcpTransport is responsible for delivering data to the appropriate application
process
on the host computer. A host and port number are combined to create a network
socket (an
